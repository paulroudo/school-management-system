...
$sql="select * from class_timetable where class_id=2;";
...
<html>
  ...
  <body ><div><a style="float:right" href="logout.php"><button>Log out</button></a></div><br/></br>
      <div> <?php
        ...
        ?></div><CENTER>
    <h1>Update Class Timetable For Form 2</h1>
    <form method="POST" action="form2time.php">
        <fieldset>
