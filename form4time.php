...
<html>
  ...
  <body ><div><a style="float:right" href="logout.php"><button>Log out</button></a></div><br/></br>
      <div> <?php
        ...
        ?></div><CENTER>
    <h1>Update Class Timetable For Form 4</h1>
    <form method="POST" action="form4time.php">
        <fieldset>
